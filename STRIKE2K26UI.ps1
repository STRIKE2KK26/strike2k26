...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
        ...
        Title="STRIKE 2K26" Height="760" Width="1150"
    ...
    <Border CornerRadius="4" BorderThickness="1" BorderBrush="#22000000">
        ...
        <Grid>
            ...
            <Image x:Name="BgMedia" Grid.RowSpan="2" Stretch="UniformToFill" Opacity="1.0" HorizontalAlignment="Stretch" VerticalAlignment="Stretch" gif:ImageBehavior.AnimatedSource="BG_PATH_PLACEHOLDER" />
            
            <Grid Grid.Row="0" Background="Transparent" x:Name="TitleBar">
                <StackPanel Orientation="Horizontal" VerticalAlignment="Center" Margin="20,0,0,0">
                    <Ellipse x:Name="TitleDot" Width="6" Height="6" Fill="{DynamicResource TitleDotColor}"/>
                    <TextBlock Text="sᴛʀɪᴋᴇ 𝟸ᴋ𝟸𝟼" Foreground="#111827" FontWeight="Bold" Margin="8,0,0,0" FontSize="11" FontFamily="Segoe UI"/>
                </StackPanel>
                ...
                <Border Grid.Column="0" Background="#A0FFFFFF" BorderThickness="0,0,1,0" BorderBrush="#15000000" CornerRadius="0" ClipToBounds="True">
                    <Grid>
                        ...
                        <StackPanel Grid.Row="0">
                            ...
                            <TextBlock Text="STRIKE 2K26" Foreground="#111827" FontWeight="Bold" FontSize="16" HorizontalAlignment="Center" Margin="0,2,0,0"/>
                                ...
                                <Grid>
                                    ...
                                    <Canvas>
                                     ...
                                     <Border HorizontalAlignment="Left" VerticalAlignment="Bottom" Margin="30,0,0,25">
                                         <StackPanel>
                                             <TextBlock Text="STRIKE" Foreground="White" FontFamily="Impact" FontSize="32" Opacity="0.95">
                                                 <TextBlock.Effect>
                                                     <DropShadowEffect BlurRadius="8" ShadowDepth="4" Direction="270" Color="Black" Opacity="0.9"/>
                                                 </TextBlock.Effect>
                                             </TextBlock>
                                             <TextBlock Text="ROLEPLAY SERVER" Foreground="White" FontFamily="Segoe UI" FontSize="11" FontWeight="Bold" Margin="2,0,0,0" Opacity="0.9">
                                                 <TextBlock.Effect>
                    ...
                    <Grid Grid.Row="0">
                        ...
                        <Grid x:Name="ViewDashboard" Visibility="Visible">
                            ...
                            <StackPanel Grid.Row="0" Margin="0,0,0,20">
                                <TextBlock Text="Dashboard" Foreground="#111827" FontSize="30" FontWeight="Bold"/>
                                <TextBlock Text="แดชบอร์ดแสดงสถานะและปรับแต่งระบบ" Foreground="#4B5563" FontSize="15" Margin="0,6,0,0"/>
                            </StackPanel>
                            ...
                            <Border x:Name="BannerImage" Grid.Row="1" Height="140" CornerRadius="2" Margin="0,0,0,25" BorderThickness="1" BorderBrush="#22000000" ClipToBounds="True">
                                ...
                                <Grid>
                                    ...
                                    <StackPanel VerticalAlignment="Center" Margin="30,0,0,0" HorizontalAlignment="Left">
                                        <TextBlock Text="STRIKE 2K26" Foreground="#111827" FontSize="26" FontWeight="Black">
                                            <TextBlock.Effect>
                        ...
                        <Grid x:Name="ViewCPU" Visibility="Collapsed">
                            ...
                            <StackPanel Grid.Row="0" Margin="0,0,0,25">
                                <TextBlock Text="CPU / Priority" Foreground="#111827" FontSize="30" FontWeight="Bold"/>
                                <TextBlock Text="ค่าเริ่มต้นระบบ (ยังไม่ปรับแต่ง)" Foreground="#4B5563" FontSize="15" Margin="0,6,0,0"/>
                            </StackPanel>
                        ...
                        <Grid x:Name="ViewInput" Visibility="Collapsed">
                            ...
                            <StackPanel Grid.Row="0" Margin="0,0,0,30">
                                <TextBlock Text="Input (Mouse/Keyboard)" Foreground="#111827" FontSize="30" FontWeight="Bold"/>
                                <TextBlock Text="ตั้งค่าลดความหน่วง (Lowest Input Lag)" Foreground="#4B5563" FontSize="15" Margin="0,6,0,0"/>
                            </StackPanel>
                        ...
                        <Grid x:Name="ViewNetwork" Visibility="Collapsed">
                            ...
                            <StackPanel Grid.Row="0" Margin="0,0,0,30">
                                <TextBlock Text="Network (QoS / TCP)" Foreground="#111827" FontSize="30" FontWeight="Bold"/>
                                <TextBlock Text="ตั้งค่าลดปิงและความหน่วง (Ping &amp; Latency)" Foreground="#4B5563" FontSize="15" Margin="0,6,0,0"/>
                            </StackPanel>
                        ...
                        <Grid x:Name="ViewPower" Visibility="Collapsed">
                            ...
                            <StackPanel Grid.Row="0" Margin="0,0,0,30">
                                <TextBlock Text="Power / Timer" Foreground="#111827" FontSize="30" FontWeight="Bold"/>
                                <TextBlock Text="การตั้งค่าและปรับแต่งระบบเพิ่มเติม" Foreground="#4B5563" FontSize="15" Margin="0,6,0,0"/>
                            </StackPanel>
                        ...
                        <Grid x:Name="ViewTools" Visibility="Collapsed">
                            ...
                            <StackPanel Grid.Row="0" Margin="0,0,0,30">
                                <TextBlock Text="เครื่องมือ (Tools)" Foreground="#111827" FontSize="30" FontWeight="Bold"/>
                                <TextBlock Text="เครื่องมือจัดการระบบ และทำความสะอาดหน่วยความจำ (RAM Cleaner)" Foreground="#4B5563" FontSize="15" Margin="0,6,0,0"/>
                            </StackPanel>
                        ...
                        <Grid x:Name="ViewRestore" Visibility="Collapsed">
                            ...
                            <StackPanel Grid.Row="0" Margin="0,0,0,30">
                                <TextBlock Text="คืนค่าเดิม (Restore)" Foreground="#111827" FontSize="30" FontWeight="Bold"/>
                                <TextBlock Text="สำรองและคืนค่าระบบ" Foreground="#4B5563" FontSize="15" Margin="0,6,0,0"/>
                            </StackPanel>
            ...
            <Grid x:Name="AuthContainer" Grid.Row="1" Visibility="Visible">
                ...
                <Border Width="400" Height="520" CornerRadius="24" HorizontalAlignment="Center" VerticalAlignment="Center" BorderThickness="1">
                    ...
                    <Border.Effect>
                        <DropShadowEffect BlurRadius="50" ShadowDepth="15" Color="#000000" Opacity="1.0"/>
                    </Border.Effect>
                    ...
                    <Grid Margin="35,40,35,30">
                        ...
                        <StackPanel Grid.Row="0" HorizontalAlignment="Center" Margin="0,0,0,35">
                            ...
                            <TextBlock Text="STRIKE 2K26" Foreground="#111827" FontSize="20" FontWeight="Light" HorizontalAlignment="Center">
                                <TextBlock.Effect>
                                    <DropShadowEffect BlurRadius="5" ShadowDepth="0" Color="#000000" Opacity="0.8"/>
                                </TextBlock.Effect>
                            </TextBlock>
                            <TextBlock Text="SYSTEM V2.0" Foreground="#6B7280" FontSize="10" FontWeight="SemiBold" HorizontalAlignment="Center" Margin="0,4,0,0"/>
                        </StackPanel>
                        ...
                        <StackPanel x:Name="AuthLoginView" Grid.Row="1" Visibility="Visible">
                            ...
                            <Border Background="#10ffffff" BorderBrush="#22ffffff" BorderThickness="1" CornerRadius="10" Padding="15,12" Margin="0,0,0,30">
                                <Grid>
                                    <PasswordBox x:Name="TxtLoginPassword" Background="Transparent" Foreground="#111827" CaretBrush="White" BorderThickness="0" FontSize="14" Margin="0,0,30,0" VerticalContentAlignment="Center"/>
                                    <TextBox x:Name="TxtLoginPasswordVisible" Visibility="Collapsed" Background="Transparent" Foreground="#111827" CaretBrush="White" BorderThickness="0" FontSize="14" Margin="0,0,30,0" VerticalContentAlignment="Center"/>
...
$scriptDir = Split-Path -Parent $MyInvocation.MyCommand.Definition
if (-not $scriptDir) { $scriptDir = $PWD.Path }
$bgPath = Join-Path $scriptDir "solo-leveling-3840x2160-26864.jpg"
...
# STARTUP
Write-Log "STRIKE 2K26 ready  |  Administrator"
Update-SystemInfo
Update-Status
...
$window.FindName("BtnRestorePoint").Add_Click({
    Run-Tweak -Btn $window.FindName("BtnRestorePoint") -LoadingText "CREATING BACKUP..." -Action {
        try {
            ...
            Checkpoint-Computer -Description "STRIKE 2K26 Backup" -RestorePointType "MODIFY_SETTINGS" -ErrorAction Stop
        } catch { }
    }
})
...
$avatarPath = Join-Path $scriptDir "fanart.png"
...
$sidebarPath = Join-Path $scriptDir "22.jpg"
...
if (Test-Path $bgmPath) {
    ...
    $global:bgmPlayer.Add_MediaEnded({
        $global:bgmPlayer.Position = [TimeSpan]::Zero
...
$appDataDir = Join-Path $env:APPDATA "STRIKE 2K26"
...
$window.FindName("BtnLogin").Add_Click({
    ...
    # KeyAuth Credentials
    $keyauth_name = "STRIKE"
    $keyauth_owner = "Fasrhx4mDf"
    $keyauth_ver = "1.0"
    $keyauth_secret = "0db2bbd2cbacbfe169781b94e7a026d661bca2845bf55379cf3257870ca3f17e"
    ...
    try {
        ...
        if ($loginResp.success -eq $true) {
            ...
            # Login successful
            $window.Resources["WindowControlForeground"] = [System.Windows.Media.SolidColorBrush]::new([System.Windows.Media.ColorConverter]::ConvertFromString("#777777"))
            $window.Resources["TitleDotColor"] = [System.Windows.Media.SolidColorBrush]::new([System.Windows.Media.ColorConverter]::ConvertFromString("#111827"))
